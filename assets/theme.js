...
slate.Variants = (function() {
  ...
  Variants.prototype = Object.assign({}, Variants.prototype, {
    ...
    _onSelectChange: function() {
      ...
      this._updateProductDetailTab( variant );
    ...
    // METHOD TO CHANGE THE PRODUCT DETAIL TAB TABLE FOR THE PROPER SELECTION
    _updateProductDetailTab: function( variant ) {
      ...
      // if ( table_us != null && table_eu != null ) {
      //   console.log( table_eu );
      //   if ( variant.option2 == 'US' ) {
      //     table_us.style.display = 'block';
      //     table_eu.style.display = 'none' ;
      //   } else if ( variant.option2 == 'EU' ) {
      //     table_eu.style.display = 'block';
      //     table_us.style.display = 'none' ;
      //   } else {
      //     table_us.style.display = 'none';
      //     table_eu.style.display = 'none' ;
      //   }
...
// MAKING SURE THAT THE PRODUCT DETAIL TAB ALWAYS DISPLAYS THE PROPER TABLE ON PAGE LOAD
var variant_select = document.querySelector( '#SingleOptionSelector-1' );
var table_us = document.querySelector( '.product-tab-details-us' );
var table_eu = document.querySelector( '.product-tab-details-eu' );
// if ( table_us && table_eu ) {
//   if ( variant_select.value == 'US' ) {
//     table_us.style.display = 'block';
//     table_eu.style.display = 'none' ;
//   }
//   else if ( variant_select.value == 'EU' ) {
//     table_eu.style.display = 'block';
//     table_us.style.display = 'none' ;
//   } else {
//     table_us.style.display = 'none';
